    ...
    return (
        <div className="mb-5">
            <Navbar className="py-4" bg="danger" variant="dark">
                <Container>
                    <Navbar.Brand href="#"><img className="me-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcP2lD4WQdnhULK9LUPEV4LaAvoH9_rU9hjpohjQX4ojKLfyAxraqbz0jfa10JIAJwP9Y&usqp=CAU" height="40px" alt=""></img>Learn Japanese</Navbar.Brand>
